...
public class VentanaInicial extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        panel.add(etiquetaTitulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(116, 13, 385, 79));

        etiquetaUsuario1.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        etiquetaUsuario1.setText("Digite el nombre del usuario 1: ");
        panel.add(etiquetaUsuario1, new org.netbeans.lib.awtextra.AbsoluteConstraints(48, 99, -1, 28));

        etiquetaUsuario2.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        etiquetaUsuario2.setText("Digite el nombre del usuario 2: ");
        panel.add(etiquetaUsuario2, new org.netbeans.lib.awtextra.AbsoluteConstraints(48, 160, -1, -1));

        cajaNombre1.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        panel.add(cajaNombre1, new org.netbeans.lib.awtextra.AbsoluteConstraints(314, 99, 249, 34));
        ...
        panel.add(cajaNombre2, new org.netbeans.lib.awtextra.AbsoluteConstraints(314, 146, 249, 34));

        gifTresEnRaya.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/tresEnRaya.gif"))); // NOI18N
        panel.add(gifTresEnRaya, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 230, -1, -1));
        ...
        panel.add(botonGuardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(247, 209, 119, 42));

        etiquetaMuestra1.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        etiquetaMuestra1.setForeground(new java.awt.Color(255, 0, 0));
        panel.add(etiquetaMuestra1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 260, 318, 30));

        etiquetaMuestra2.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        etiquetaMuestra2.setForeground(new java.awt.Color(0, 51, 255));
        panel.add(etiquetaMuestra2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 290, 318, 32));
        ...
        panel.add(botonComenzarJuego, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 360, -1, -1));
    ...
    private void botonGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonGuardarActionPerformed
        ...
        etiquetaMuestra2.setText(usuario2+" su ficha es la: O");
